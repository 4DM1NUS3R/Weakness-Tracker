...
function Navigation(){
    ...
    return(
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container-fluid" style={{marginLeft: '18%', marginRight: '18%',display: 'flex' }}>
                <Link to = "/"><a class="navbar-brand" href="#">Weakness Tracker®</a>  </Link>
                <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarTogglerDemo02" aria-controls="navbarTogglerDemo02" aria-expanded="false" aria-label="Toggle navigation">
                    <span class="navbar-toggler-icon"></span>
                </button>

            <div class="navbar-collapse collapse " id="navbarTogglerDemo02" style = {{ display: 'flex', justifyContent: 'flex-end'}} >
                    <ul class=" navbar-nav me-auto mb-2 mb-lg-0" >
                        ...
                        <Link to = "Contact"> 
                            <li class="nav-link active" style = {{ }}> 

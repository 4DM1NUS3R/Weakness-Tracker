                ...
                <div className= "conteneur" style= {{ width: '100%', display: 'flex', justifyContent: 'flex-start'}}>
                    ...
                    <div className= "contenu">
                        ...
                        <div className= "partie2" style= {{ marginBottom: '10%'}}> 
                             <h3 style= {{ color: 'rgb(9, 126, 58)', marginBottom: '20px'}}> Vulnérabilités connues </h3>
                        ...
                        <div className= "partie3" style= {{ marginBottom: '7%'}}> 
                             <h3 style= {{ color: 'rgb(9, 126, 58)', marginBottom: '20px'}}> Comment sécuriser le réseau de son entreprise ? </h3>
